    ...
    <div class="footer_content wrapper">
        ...
        <div class="footer_contacts">
            <div class="footer_wraper-contacts">
                <a href="tel:'<?php echo get_post_meta( 69, 'tel1', true ); ?>'" class="footer_phone-number"><?php echo get_post_meta( 69, 'tel1', true ); ?></a>
                <a href="tel:'<?php echo get_post_meta( 69, 'tel2', true ); ?>'" class="footer_phone-number"><?php echo get_post_meta( 69, 'tel2', true ); ?></a>
