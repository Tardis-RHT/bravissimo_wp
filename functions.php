    ...
    register_post_type('library', // Register Custom Post Type
        array(
            ...
            'labels' => array(
                ...
                'add_new' => __('Add New', 'html5blank'),
                'add_new_item' => __('Add New Library Post', 'html5blank'),
                'edit' => __('Edit', 'html5blank'),
                'edit_item' => __('Edit Library Post', 'html5blank'),
                'new_item' => __('New Library Post', 'html5blank'),
                'view' => __('View Library Post', 'html5blank'),
                'view_item' => __('View Library Post', 'html5blank'),
                'search_items' => __('Search Library Post', 'html5blank'),
                'not_found' => __('No Library Posts found', 'html5blank'),
                'not_found_in_trash' => __('No Library found in Trash', 'html5blank')
            ),
            'public' => true,
            'hierarchical' => true, // Allows your posts to behave like Hierarchy Pages
            'has_archive' => true,
